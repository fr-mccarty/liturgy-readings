<div class="pt-2 pb-3 space-y-1">
    ...
    <x-responsive-nav-link href="{{ route('wedding-prayers') }}" :active="request()->routeIs('wedding-prayers')">
        Wedding Prayers
    </x-responsive-nav-link>
    ...
    <x-responsive-nav-link href="{{ route('funeral-prayers') }}" :active="request()->routeIs('funeral-prayers')">
        Funeral Prayers
    </x-responsive-nav-link>
</div>
